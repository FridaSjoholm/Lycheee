...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
    {
        ...
        self.auth.clientID = @"746a264276104f1ea2d6988d04621002";
        self.auth.redirectURL = [NSURL URLWithString:@"lycheee-spotify-app://callback"];
...
- (BOOL)application:(UIApplication *)app
    ...
    //THIS IS WHERE I PLAY THE SONGS
